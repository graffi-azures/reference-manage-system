...
public class NewRefController implements Initializable {
    public Tab refTab;
    public Tab ataTab;
    ...
    @FXML
    private ChildAtaController ataContentController;
    @FXML
...
//        ataContentController.injectController(this);
        ...
        ataContentController = (ChildAtaController) StageManager.CONTROLLER.get("ataContentController");
    }
